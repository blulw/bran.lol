...
async def stats(username: str = "aiden"):
    print(f"Requested stats for username: {username}")  # Log the username
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if match:
                ...
                print(f"Views for {username}: {views}")  # Log the views count
            else:
        ...
        return HTMLResponse(content="An error occurred while processing your request.", status_code=500)
